            ...
            <div class="tw-bg-white tw-shadow-md tw-rounded tw-px-3 md:tw-px-8 tw-pt-3 md:tw-pt-6 tw-pb-3 md:tw-pb-8 tw-mb-4">
                ...
                <div class="tw-mb-4">
                    ...
                    <search-form
                        ...
                        url="{{ route('bordereauremise.fetch') }}"
                        :params="{
                            search: '',
                        ...
                        <form class="tw-grid tw-grid-cols-8 tw-col-gap-4 tw-pb-3 tw-border-b tw-border-gray-400">
                            ...
                            <div class="tw-col-span-4 md:tw-col-span-2">
                                ...
                                <div class="relative">
                                    ...
                                    >
                                        <option value="numero_transaction:asc">Numéro Transaction ASC</option>
                                        <option value="numero_transaction:desc">Numéro Transaction DESC</option>
                                        <option value="localisation:asc">Localisation ASC</option>
                                        <option value="localisation:desc">Localisation DESC</option>
                                    </select>
                            ...
                            <template v-if="records.length">
                                ...
                                >
                                    <div class="tw-flex-auto tw-pr-3">
                                        @{{ record.numero_transaction }} @{{ record.localisation }}
                                    </div>
