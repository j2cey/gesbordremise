...
class CreateFieldsRequiredWithoutTable extends Migration
{
    use BaseMigrationTrait;

    public $table_name = 'fields_required_without';
    public $table_comment = 'liste des champs dont la présence rend le champs d action facultatif.';
